...
object RetCalc {
  def futureCapital(interestRate: Double, nbOfMonths: Int,
    ...
    def simulatePlan(interestRate: Double, nbOfMonthsSaving: Int, nbOfMonthsInRetirement: Int,
      ...
      val capitalAtRetirement = futureCapital(interestRate = interestRate, nbOfMonths = nbOfMonthsSaving,
                                              netIncome = netIncome, currentExpenses = currentExpenses,
                                              initialCapital = initialCapital)

      val capitalAfterDeath = futureCapital(interestRate = interestRate, nbOfMonths = nbOfMonthsInRetirement,
